...
extern "C" JNIEXPORT jlong Java_ad_libvips_VImage_create(JNIEnv* env, jobject thiz, jstring _filename){
	if(!nativePtrField){
...
extern "C" JNIEXPORT void Java_ad_libvips_VImage_release(JNIEnv* env, jobject thiz){
...
extern "C" JNIEXPORT jint Java_ad_libvips_VImage_getWidth(JNIEnv* env, jobject thiz){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return 0;
...
extern "C" JNIEXPORT jint Java_ad_libvips_VImage_getHeight(JNIEnv* env, jobject thiz){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return 0;
...
extern "C" JNIEXPORT jobject Java_ad_libvips_VImage_resize(JNIEnv* env, jobject thiz, jdouble scale, jobjectArray outputs){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return NULL;
	VipsImage* resized;
...
extern "C" JNIEXPORT jobject Java_ad_libvips_VImage_crop(JNIEnv* env, jobject thiz, jint left, jint top, jint width, jint height){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return NULL;
	VipsImage* cropped;
...
extern "C" JNIEXPORT void Java_ad_libvips_VImage_writeToFile(JNIEnv* env, jobject thiz, jobjectArray outputs){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return;
...
extern "C" JNIEXPORT jboolean Java_ad_libvips_VImage_hasAlpha(JNIEnv* env, jobject thiz){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return false;
...
extern "C" JNIEXPORT jobject Java_ad_libvips_VImage_flatten(JNIEnv* env, jobject thiz, jdouble r, jdouble g, jdouble b){
	VipsImage* img=(VipsImage*)(intptr_t)env->GetLongField(thiz, nativePtrField);
	if(!ensureNotReleased(img, env))
		return NULL;
